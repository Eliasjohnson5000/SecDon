...
let
  ...
  sysc-greet = pkgs.buildGoModule rec {
    ...
    src = pkgs.fetchFromGitHub {
      ...
      repo = "sysc-greet";
      rev = "master";
      sha256 = "sha256-d8sMZdSHOsFgaOhVmK2w0Rm+edMgGP6Mq9k19WNkfa0=";
      #was: sha256-SEAtVGxn2ZrNbHA+eS79sJCMytlhCFtVJ0l6/pj+b4w=
    };

    vendorHash = "sha256-dNkp1/ms1dO6sWNK9qYVq9VGWuFbyMlqdAn+D8vpZ8w=";
    #was:sha256-n/WQaEWYPlVZs1xNOER1tx5I6FwoU0IahZFZZGD4saA=
